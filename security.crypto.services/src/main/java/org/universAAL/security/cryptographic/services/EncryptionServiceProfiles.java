...
public class EncryptionServiceProfiles extends EncryptionService {
	...
	static void initialize(ModuleContext mc) {
		...
		/*
		 * Service Profiles XXX: Method may not need to be an input, it might
		 * just be a restriction?
		 */
		// AES
		// Encrypt resource using given method
		EncryptionServiceProfiles eAES = new EncryptionServiceProfiles(ENCRYPT_AES);
		eAES.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
		...
		eAES.addOutput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
		...
		dAES.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dAES.addFilteringInput(METHOD, AES.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		dAES.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dAES.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });

		// Decrypt encrypted resource using ER method, Key through service
		// method
		EncryptionServiceProfiles dAES_TER = new EncryptionServiceProfiles(DECRYPT_AES_TER);
		dAES_TER.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dAES_TER.addFilteringInput(METHOD, AES.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dAES_TER.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dAES_TER.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		dAES_WOM.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, SymmetricEncryption.PROP_SIMPLE_KEY });
		dAES_WOM.addFilteringInput(METHOD, AES.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dAES_WOM.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dAES_WOM.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		eBlow.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		eBlow.addFilteringInput(METHOD, Blowfish.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		eBlow.addFilteringInput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		eBlow.addOutput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });

		EncryptionServiceProfiles dBlow = new EncryptionServiceProfiles(DECRYPT_BLOWFISH);
		dBlow.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dBlow.addFilteringInput(METHOD, Blowfish.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		dBlow.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dBlow.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });

		// Decrypt encrypted resource using ER method, Key through service
		// method
		EncryptionServiceProfiles dBlow_TER = new EncryptionServiceProfiles(DECRYPT_BLOWFISH_TER);
		dBlow_TER.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dBlow_TER.addFilteringInput(METHOD, Blowfish.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dBlow_TER.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dBlow_TER.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });

		// Decrypt encrypted resource using ER method, Key attached to ER Method
		EncryptionServiceProfiles dBlow_WOM = new EncryptionServiceProfiles(DECRYPT_BLOWFISH_WOM);
		dBlow_WOM.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, SymmetricEncryption.PROP_SIMPLE_KEY });
		dBlow_WOM.addFilteringInput(METHOD, Blowfish.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dBlow_WOM.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dBlow_WOM.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		eDES.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		eDES.addFilteringInput(METHOD, DES.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		eDES.addFilteringInput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		eDES.addOutput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });

		EncryptionServiceProfiles dDES = new EncryptionServiceProfiles(DECRYPT_DES);
		dDES.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dDES.addFilteringInput(METHOD, DES.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		dDES.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dDES.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		dAES_TER.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		dAES_TER.addFilteringInput(METHOD, DES.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dAES_TER.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dAES_TER.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
		...
		dDES_WOM.addFilteringInput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, SymmetricEncryption.PROP_SIMPLE_KEY });
		dDES_WOM.addFilteringInput(METHOD, DES.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dDES_WOM.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dDES_WOM.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		eRSA.addFilteringInput(KEY, KeyRing.MY_URI, 1, 1,
		...
		eRSA.addFilteringInput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		eRSA.addOutput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });

		EncryptionServiceProfiles dRSA = new EncryptionServiceProfiles(DECRYPT_RSA);
		dRSA.addFilteringInput(KEY, KeyRing.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, AsymmetricEncryption.PROP_KEY_RING });
		dRSA.addFilteringInput(METHOD, RSA.MY_URI, 1, 1, new String[] { EncryptionService.PROP_ENCRYPTION });
		dRSA.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dRSA.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });

		// Decrypt encrypted resource using ER method, Key through service
		// method
		EncryptionServiceProfiles dRSA_TER = new EncryptionServiceProfiles(DECRYPT_RSA_TER);
		dRSA_TER.addFilteringInput(KEY, KeyRing.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, AsymmetricEncryption.PROP_KEY_RING });
		dRSA_TER.addFilteringInput(METHOD, RSA.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dRSA_TER.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dRSA_TER.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });

		// Decrypt encrypted resource using ER method, Key attached to ER Method
		EncryptionServiceProfiles dRSA_WOM = new EncryptionServiceProfiles(DECRYPT_RSA_WOM);
		dRSA_WOM.addFilteringInput(KEY, KeyRing.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, AsymmetricEncryption.PROP_KEY_RING });
		dRSA_WOM.addFilteringInput(METHOD, RSA.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.PROP_ENCRYPTION });
		dRSA_WOM.addFilteringInput(ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTED_RESOURCE });
		dRSA_WOM.addOutput(CLEAR_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTS });
		...
		gRSA.addFilteringInput(KEY_LENGTH, TypeMapper.getDatatypeURI(Integer.class), 0, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, RSA.PROP_KEY_RING, KeyRing.PROP_KEY_LENGTH });
		gRSA.addOutput(KEY, KeyRing.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, RSA.PROP_KEY_RING });
		...
		gAES.addFilteringInput(KEY_LENGTH, TypeMapper.getDatatypeURI(Integer.class), 0, 1, new String[] {
				EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY, SimpleKey.PROP_KEY_LENGTH });
		gAES.addOutput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		...
		gBlow.addFilteringInput(KEY_LENGTH, TypeMapper.getDatatypeURI(Integer.class), 0, 1, new String[] {
				EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY, SimpleKey.PROP_KEY_LENGTH });
		gBlow.addOutput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
		...
		gDES.addFilteringInput(KEY_LENGTH, TypeMapper.getDatatypeURI(Integer.class), 0, 1, new String[] {
				EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY, SimpleKey.PROP_KEY_LENGTH });
		gDES.addOutput(KEY, SimpleKey.MY_URI, 1, 1,
				new String[] { EncryptionService.PROP_ENCRYPTION, SymmetricEncryption.PROP_SIMPLE_KEY });
